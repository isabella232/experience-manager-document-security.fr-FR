...
* Protéger tous les documents à l’aide d’une stratégie par défaut.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>GUID de la stratégie à utiliser lorsque de nouveaux documents sont enregistrés. S’applique à la fonction d’application automatique de la stratégie.</p> </td>
   <td><p>ID de stratégie hexadécimal visible sur le serveur RM</p> </td>
  </tr>
  <tr>
